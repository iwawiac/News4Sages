...
public class ArticlesUtilityTest {
    ...
    // Additional corner cases to test later: createURLTopHeadlines gets incorrect parameters,
    // getJsonFromAPIRequest gets empty string/ incorrect request URL
    // getArticlesFromJson gets null/ empty as a parameter
    ...
    @org.junit.Test
    public void givenExpectedRequestStatus_getJsonFromAPIRequestAndGetStatus_checkIfStatusOk() throws Exception {
    ...
    @org.junit.Test
    public void givenParsedString_getArticlesFromJson_checkIfTextOutputIsOk() {
